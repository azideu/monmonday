...
// Color locked to #D4F1FF (Sky Mist)
const SKY_MIST_COLOR = {
  r: 212 / 255, // 0.8314
  g: 241 / 255, // 0.9451
  b: 255 / 255, // 1.0000
};
...
export default function FluidCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(c) {
      ...
      let glContext = c.getContext('webgl2', params);
      const isWebGL2 = Boolean(glContext);
      if (!glContext) {
        glContext = c.getContext('webgl', params) || c.getContext('experimental-webgl', params);
      }
      ...
      if (isWebGL2) {
        ...
        supportLinearFiltering = Boolean(glContext.getExtension('OES_texture_float_linear'));
      } else {
        halfFloat = glContext.getExtension('OES_texture_half_float');
        supportLinearFiltering = Boolean(glContext.getExtension('OES_texture_half_float_linear'));
      }
